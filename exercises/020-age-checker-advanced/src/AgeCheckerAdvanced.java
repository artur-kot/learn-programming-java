...
public class AgeCheckerAdvanced {
    ...
    public static void displayPermissions(int age) {
        ...
        System.out.println("Can drive: " + (age >= 16 ? "✓ YES" : "✗ NO"));
        System.out.println("Can work: " + (age >= 14 ? "✓ YES" : "✗ NO"));
        System.out.println("Can sign contracts: " + (age >= 18 ? "✓ YES" : "✗ NO"));
        System.out.println("Can drink alcohol: " + (age >= 21 ? "✓ YES" : "✗ NO"));
    }
