...
14. - [x] **Calculator - Input Validation**
...
*Learn switch statements and menu-driven design with real-world formulas.*
16. - [ ] **Temperature Converter - Switch Statements**
Build a comprehensive temperature converter supporting Celsius ↔ Fahrenheit ↔ Kelvin conversions using switch statements for menu routing.
**Concepts:** switch statements, temperature formulas, menu-driven design, input validation, floating-point arithmetic.

---

### **Series 5: BMI Calculator**

*Combine math, input validation, and conditional logic.*
17. - [x] **BMI Calculator - Basics**
    Input weight and height, calculate and display BMI.
    **Concepts:** input validation, math formulas, try...catch, formatting.

18. - [x] **BMI Calculator - Advanced**
    Add BMI interpretation (categories) and support multiple calculations.
    **Concepts:** if/else logic, string comparison, loop menus, code reuse.
...
### **Series 7: Counting App**

*Automate repetitive tasks with loops.*
21. - [x] **Counter - Count Up and Down**
Print numbers 1–10, then 10–1.
**Concepts:** for loop, loop modification, increment/decrement.

22. - [x] **Counter - Sum Range**
    Sum all numbers up to N.
    **Concepts:** accumulators, variables.

---

### **Series 8: Multiplication Table**

*Practice nested loops.*
23. - [ ] **Multiplication Table - Nested Loops**
Build multiplication tables from single number to full 1-10 grid using nested loops and formatting.
**Concepts:** nested loops, formatted output, loop control.

---

### **Series 9: Guessing Game**

*Combine loops, random numbers, and logic.*
24. - [ ] **Guessing Game - Random Numbers & Loops**
Build a complete interactive guessing game combining random numbers, while loops, hints, attempt tracking, and replay functionality.
**Concepts:** `Random` class, while loops, nested loops, conditional feedback, game flow, counters.

---

## **Phase 5: Functions and Reuse**

### **Series 10: Methods Basics**

*Structure reusable logic.*
25. - [ ] **Methods Basics - Define, Parameters & Return Values**
...
27. - [ ] **Calc Refactor - Operations as Methods**
Move add, subtract, multiply, divide into separate methods.
**Concepts:** modular design.

28. - [ ] **Calc Refactor - Validation Method**
    Reuse validation logic.
    **Concepts:** code reuse.

29. - [ ] **Calc Refactor - Menu System**
...
30. - [ ] **Array - Declare and Print**
Create an array of numbers.
**Concepts:** indexing, iteration.

31. - [ ] **Array - Sum and Average**
    Compute total and average.
    **Concepts:** for loops, aggregation.

32. - [ ] **Array - Find Max/Min**
...
43. - [ ] **To-Do - Remove Task**
    Delete by index.
    **Concepts:** input parsing, validation.

44. - [ ] **To-Do - Complete Task**
    Mark tasks as done.
    **Concepts:** conditional updates.

45. - [ ] **To-Do - Menu Driven App**
...
65. - [ ] **Exceptions - Divide by Zero**
    Handle `ArithmeticException`.
    **Concepts:** try/catch.

66. - [ ] **Exceptions - Input Errors**
    Handle invalid `Scanner` input.
    **Concepts:** exception control flow.

67. - [ ] **Exceptions - Custom Exception**
...
68. - [ ] **File - Write Text File**
Save user data to a file.
**Concepts:** `FileWriter`, I/O.

69. - [ ] **File - Read Text File**
    Load data from file.
